...
item replace entity @s[advancements={advancements:custom/unlock_prefix=true}] enderchest.10 with minecraft:name_tag{HideFlags:63,display:{Name:'[{"text":"Exclusive Prefix","color":"dark_gray","italic":false,"bold":true}]',Lore:['[{"text":"Unlocked","color":"green","italic":false}]']},clickable:1}
item replace entity @s[tag=prefix,advancements={advancements:custom/unlock_prefix=true}] enderchest.10 with minecraft:name_tag{HideFlags:63,display:{Name:'[{"text":"Exclusive Prefix","color":"dark_gray","italic":false,"bold":true}]',Lore:['[{"text":"Unlocked","color":"green","italic":false}]','[{"text":"Selected","color":"blue","italic":false}]']},clickable:1,Enchantments:[{id:"minecraft:x",lvl:1s}]}
...
item replace entity @s[advancements={advancements:custom/unlock_lobby_mount=true}] enderchest.12 with minecraft:saddle{HideFlags:63,display:{Name:'[{"text":"Exclusive Lobby Mount","color":"green","italic":false,"bold":true}]',Lore:['[{"text":"Unlocked","color":"green","italic":false}]']},clickable:1}
...
item replace entity @s[advancements={advancements:custom/unlock_trident_effect=true}] enderchest.14 with minecraft:trident{HideFlags:63,display:{Name:'[{"text":"Exclusive Trident Effect","color":"gold","italic":false,"bold":true}]',Lore:['[{"text":"Unlocked","color":"green","italic":false}]']},clickable:1}
...
item replace entity @s[advancements={advancements:custom/unlock_death_message=true}] enderchest.16 with minecraft:bone{HideFlags:63,display:{Name:'[{"text":"Exclusive Death Message","color":"red","italic":false,"bold":true}]',Lore:['[{"text":"Unlocked","color":"green","italic":false}]']},clickable:1}
