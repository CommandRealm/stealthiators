...
##Middle row
item replace entity @s[tag=has_test] enderchest.0 with book{clickable:1,HideFlags:63,display:{Name:'[{"text":"(Tester)","bold":false,"italic":false,"color":"gray"}]'}}
item replace entity @s[tag=has_help] enderchest.1 with book{clickable:1,HideFlags:63,display:{Name:'[{"text":"[Helper]","bold":false,"italic":false,"color":"dark_gray"}]'}}
