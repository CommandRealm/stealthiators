...
execute if score $options set_timer matches 1 run setblock 25 68 -40 oak_wall_sign[facing=east]{Text1:'{"text":"","color":"#a06a3e","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Timer:","color":"#70979a","bold":true}',Text3:'{"text":"1 minute","color":"yellow"}',Text4:'{"text":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:timer/click_timer"}}'}
execute if score $options set_timer matches 2.. run setblock 25 68 -40 oak_wall_sign[facing=east]{Text1:'{"text":"","color":"#a06a3e","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"Timer:","color":"#70979a","bold":true}',Text3:'[{"score":{"objective":"set_timer","name":"$options"},"color":"yellow"},{"text":" minutes","color":"yellow"}]',Text4:'{"text":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:timer/click_timer"}}'}
