...
execute if score $auto generation matches 1 run setblock 26 68 -36 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"","color":"#cbc69c","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Generation:","color":"#4d834c","bold":true}', '{"text":"Auto","color":"yellow"}', '{"text":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:generation/click_generation"}}'], has_glowing_text: false, color: "black"}}
execute if score $auto generation matches 0 run setblock 26 68 -36 oak_wall_sign[facing=east]{front_text:{messages:['{"text":"","color":"#cbc69c","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Generation:","color":"#4d834c","bold":true}', '{"text":"Custom","color":"yellow"}', '{"text":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:generation/click_generation"}}'], has_glowing_text: false, color: "black"}}
