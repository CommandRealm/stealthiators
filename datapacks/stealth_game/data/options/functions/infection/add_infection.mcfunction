...
execute if score $number infection matches 0 run setblock 26 68 -38 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Runners swap","color":"#a06a3e","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"team on death:","color":"#a06a3e","bold":true}', '{"translate":"Off","color":"red"}', '{"translate":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:infection/click_infection"}}'], has_glowing_text: false, color: "black"}}
execute if score $number infection matches 1 run setblock 26 68 -38 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Runners swap","color":"#a06a3e","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"team on death:","color":"#a06a3e","bold":true}', '{"translate":"On","color":"green"}', '{"translate":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:infection/click_infection"}}'], has_glowing_text: false, color: "black"}}
