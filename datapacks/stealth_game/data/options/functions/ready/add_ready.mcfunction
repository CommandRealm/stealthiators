...
execute if score $number auto_ready matches 0 run setblock 24 68 -42 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Auto-ready after","color":"#b2caad","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"after games:","color":"#b2caad","bold":true}', '{"translate":"Off","color":"red"}', '{"translate":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:ready/click_ready"}}'], has_glowing_text: false, color: "black"}}
execute if score $number auto_ready matches 1 run setblock 24 68 -42 oak_wall_sign[facing=east]{front_text:{messages:['{"translate":"Auto-ready after","color":"#b2caad","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"translate":"after games:","color":"#b2caad","bold":true}', '[{"translate":"On","color":"green"}]', '{"translate":"<<<         >>>","color":"#91b0be","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:ready/click_ready"}}'], has_glowing_text: false, color: "black"}}
