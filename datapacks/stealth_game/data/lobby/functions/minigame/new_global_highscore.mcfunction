...
tellraw @s {"translate":"You have now have the world highscore!","color":"green"}
...
setblock 1 1 1 air
execute as @s at @s run setblock 1 1 1 oak_sign{front_text:{messages:['[{"translate":"World Highscore: ","color":"gold"},{"score":{"objective":"highscore","name":"@p[tag=score_on_sign]"},"color":"yellow"}]', '{"translate":""}', '{"translate":""}', '{"translate":""}'], has_glowing_text: false, color: "black"}}
setblock 2 2 2 air
execute as @s at @s run setblock 2 2 2 oak_sign{front_text:{messages:['[{"translate":"Held by: ","color":"dark_green"},{"selector":"@a[tag=name_on_sign]"}]', '{"translate":""}', '{"translate":""}', '{"translate":""}'], has_glowing_text: false, color: "black"}}
