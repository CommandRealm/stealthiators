...
execute if score $score lobby_minigame matches 100.. as @a[gamemode=adventure,x=57,y=73,z=7,distance=..17,tag=!playing,scores={time_near_target=1..,lobby_trident=1..}] run advancement grant @s only minecraft:custom/hundred_points
