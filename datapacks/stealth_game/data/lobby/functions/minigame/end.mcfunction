tellraw @a[x=57,y=73,z=7,distance=..17,gamemode=adventure,scores={time_near_target=1..},tag=!playing] [{"translate":"[","color":"dark_gray","bold":true},{"translate":"☠","color":"dark_red","bold":false},{"translate":"]","color":"dark_gray","bold":true},{"translate":" Game over.","color":"red","bold":false}]
tellraw @a[x=57,y=73,z=7,distance=..17,gamemode=adventure,scores={time_near_target=1..},tag=!playing] [{"translate":"Your final score was: ","color":"gold"},{"score":{"objective":"lobby_minigame","name":"$score"},"color":"yellow","bold":true}]
