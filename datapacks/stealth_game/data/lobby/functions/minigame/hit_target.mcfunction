tag @e[type=trident,distance=..2,nbt={inBlockState:{Name:"minecraft:target"}}] add in_block
scoreboard players set $target_power lobby_minigame 0
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=1] run scoreboard players set $target_power lobby_minigame 1
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=2] run scoreboard players set $target_power lobby_minigame 2
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=3] run scoreboard players set $target_power lobby_minigame 3
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=4] run scoreboard players set $target_power lobby_minigame 4
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=5] run scoreboard players set $target_power lobby_minigame 5
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=6] run scoreboard players set $target_power lobby_minigame 6
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=7] run scoreboard players set $target_power lobby_minigame 7
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=8] run scoreboard players set $target_power lobby_minigame 8
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=9] run scoreboard players set $target_power lobby_minigame 9
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=10] run scoreboard players set $target_power lobby_minigame 10
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=11] run scoreboard players set $target_power lobby_minigame 11
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=12] run scoreboard players set $target_power lobby_minigame 12
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=13] run scoreboard players set $target_power lobby_minigame 13
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=14] run scoreboard players set $target_power lobby_minigame 14
execute at @e[type=area_effect_cloud,sort=nearest,limit=1,tag=minigame_target] if block ~ ~ ~ target[power=15] run scoreboard players set $target_power lobby_minigame 15
