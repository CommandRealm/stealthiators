...
execute if score 1 tutorial matches 10..30 as @e[type=minecraft:armor_stand,tag=tutorial_1_1] at @s run tp @s ~ ~ ~-0.096
...
execute as @e[type=minecraft:armor_stand,tag=tutorial_1_1,tag=get_running] at @s run function lobby:tutorial/get_running
