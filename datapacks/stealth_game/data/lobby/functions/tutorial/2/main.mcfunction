...
execute as @e[type=minecraft:armor_stand,tag=tutorial_2_1,tag=get_running] at @s run function lobby:tutorial/get_running
execute if score 2 tutorial matches 120.. run scoreboard players reset 2 tutorial
execute if score 2 tutorial matches 10..40 as @e[type=minecraft:armor_stand,tag=tutorial_2_1] at @s run tp @s ~0.096 ~ ~
