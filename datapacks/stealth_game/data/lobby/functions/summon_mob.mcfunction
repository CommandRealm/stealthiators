execute if entity @s[scores={lobby_mount=0}] run summon horse ~ ~ ~ {Invulnerable:1b,Tame:1b,SaddleItem:{id:"minecraft:saddle",Count:1b,tag:{CustomModelData:1,display:{Name:'{"translate":" "}'}}},Tags:["need_verification"],Invulnerable:1b,Attributes:[{Name:"generic.movement_speed",Base:0.125}],Silent:1b}
execute if entity @s[scores={lobby_mount=0}] run summon area_effect_cloud ~ ~ ~ {Duration:10000,Tags:["need_tp_verification","rideable_mob"],Invulnerable:1b,CustomName:'[{"translate":" "}]'}
execute if entity @s[scores={lobby_mount=1..}] run summon horse ~ ~ ~ {Tame:1b,SaddleItem:{id:"minecraft:saddle",Count:1b,tag:{CustomModelData:1,display:{Name:'{"translate":" "}'}}},Tags:["need_verification"],ActiveEffects:[{Id:14,Duration:1000000,ShowParticles:false,Amplifier:0}],Invulnerable:1b,Attributes:[{Name:"generic.movement_speed",Base:0.125}],Silent:1b,CustomName:'[{"translate":" "}]'}
...
execute if entity @s[scores={lobby_mount=14}] run summon sheep ~ ~ ~ {Tags:["need_tp_verification","rideable_mob"],Invulnerable:1b,PersistenceRequired:1b,CustomName:'[{"translate":"jeb_"}]'}
