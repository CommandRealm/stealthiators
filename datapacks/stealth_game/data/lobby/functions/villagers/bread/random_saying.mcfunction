execute if entity @s[tag=said_2] run function lobby:villagers/bread/saying_3
execute if entity @s[tag=said_1,tag=!said_2] run function lobby:villagers/bread/saying_2
execute if entity @s[tag=!said_1] run function lobby:villagers/bread/saying_1
