...
# summon
summon stray ~ ~ ~ {Silent:1b,Tags:["die","fake_boots","needs_adjustments"],ArmorItems:[{id:"minecraft:iron_boots",Count:1b},{},{},{id:"minecraft:light_gray_stained_glass_pane",Count:1b,tag:{CustomModelData:1}}],ActiveEffects:[{Id:14b,Duration:100000,ShowParticles:0b},{Id:11b,Duration:100000,ShowParticles:0b}],Attributes:[{Name:"generic.follow_range",Base:0.0},{Name:"generic.attack_damage",Base:0.0}]}
