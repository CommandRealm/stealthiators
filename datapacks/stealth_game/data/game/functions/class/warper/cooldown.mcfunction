...
execute as @a[scores={warp_cooldown=1..},tag=playing,team=sneaker] run title @s actionbar [{"translate":"[","color":"gold","bold":true},{"score":{"objective":"display_cooldown","name":"@s"},"color":"#b1a370","bold":true},{"translate":"]","color":"gold","bold":true}]
