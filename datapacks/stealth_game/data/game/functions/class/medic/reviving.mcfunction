...
tag @a[gamemode=adventure,distance=..2,scores={r_class=4,revive_crouch=1..},team=sneaker] add using_revive
effect give @a[gamemode=adventure,distance=..2,scores={r_class=4,revive_crouch=1..},team=sneaker] minecraft:glowing 1 0 true
