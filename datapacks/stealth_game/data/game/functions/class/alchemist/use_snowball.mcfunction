...
tag @e[type=minecraft:snowball,sort=nearest,limit=1,nbt={HasBeenShot:0b}] add alchemist_snowball
tag @e[type=minecraft:snowball,tag=alchemist_snowball] add die
