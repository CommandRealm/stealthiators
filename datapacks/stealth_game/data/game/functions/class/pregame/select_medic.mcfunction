...
execute unless entity @s[scores={r_class=4}] run tellraw @s [{"text":"Info: ","color":"gold"},{"text":"The Medic can revive caught runners by crouching where they died.","italic":true,"color":"gray"}]
