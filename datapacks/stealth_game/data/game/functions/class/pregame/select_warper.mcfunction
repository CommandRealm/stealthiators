...
execute unless entity @s[scores={r_class=3}] run tellraw @s [{"text":"Info: ","color":"gold"},{"text":"The Warper can teleport back to their position three seconds ago.","italic":true,"color":"gray"}]
