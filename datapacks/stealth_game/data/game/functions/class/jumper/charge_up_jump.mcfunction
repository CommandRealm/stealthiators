...
# giving effect
effect give @s[scores={jump_level=1}] minecraft:jump_boost 1000000 1 true
effect give @s[scores={jump_level=2}] minecraft:jump_boost 1000000 2 true
effect give @s[scores={jump_level=3}] minecraft:jump_boost 1000000 3 true
effect give @s[scores={jump_level=4}] minecraft:jump_boost 1000000 4 true
effect give @s[scores={jump_level=5}] minecraft:jump_boost 1000000 5 true
effect give @s[scores={jump_level=6}] minecraft:jump_boost 1000000 6 true
effect give @s[scores={jump_level=7}] minecraft:jump_boost 1000000 7 true
