...
scoreboard players set @s[scores={jump_level=4}] jump_charge 4

# giving effect
effect give @s[scores={jump_level=1}] jump_boost 1000000 0 true
effect give @s[scores={jump_level=2}] jump_boost 1000000 1 true
effect give @s[scores={jump_level=3}] jump_boost 1000000 2 true
effect give @s[scores={jump_level=4}] jump_boost 1000000 3 true
effect give @s[scores={jump_level=5}] jump_boost 1000000 4 true
effect give @s[scores={jump_level=6}] jump_boost 1000000 5 true
effect give @s[scores={jump_level=7}] jump_boost 1000000 6 true
