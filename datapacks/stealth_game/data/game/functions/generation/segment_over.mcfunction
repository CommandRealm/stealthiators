...
execute at @s run summon area_effect_cloud ~ 125 ~-1 {Duration:100000,Tags:["mark_band"]}
execute at @s if score $segments_left generation matches 0 run clone 987 147 -19 1055 147 -15 ~ 150 ~-5
execute at @s if score $segments_left generation matches 0 run fill ~ 125 ~-1 ~68 125 ~-5 emerald_block
execute at @s if score $segments_left generation matches 0 run fill ~ 151 ~-1 ~68 151 ~-5 structure_void replace air
execute at @s if score $segments_left generation matches 1.. run fill ~ 125 ~-1 ~68 125 ~-5 diamond_block
