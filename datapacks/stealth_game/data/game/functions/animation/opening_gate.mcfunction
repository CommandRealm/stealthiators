...
execute if score $time game matches 605 run fill 1019 151 -22 1023 151 -22 air replace iron_bars
execute if score $time game matches 607 run fill 1019 152 -22 1023 152 -22 air replace iron_bars
execute if score $time game matches 609 run fill 1019 153 -22 1023 153 -22 air replace iron_bars
execute if score $time game matches 611 run fill 1019 154 -22 1023 154 -22 air replace iron_bars
execute if score $time game matches 613 run fill 1019 155 -22 1023 155 -22 air replace iron_bars
