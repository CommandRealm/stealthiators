...
scoreboard players add @a[team=gladiator,tag=!infected_gladiator] points 4
scoreboard players add @a[team=gladiator,tag=infected_gladiator] points 1
title @a[tag=playing] title [{"translate":"Gladiators Win!","color":"red"}]
...
scoreboard players add @a[team=gladiator,tag=playing] stat_g_win 1
