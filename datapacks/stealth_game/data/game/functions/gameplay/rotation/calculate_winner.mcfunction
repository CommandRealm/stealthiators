...
tellraw @a [{"translate":"Stealthiators","color":"dark_gray","bold":true},{"translate":" Rotation Mode","color":"gold","bold":true}]
team join gold @a[scores={fake_points=0},tag=playing]
execute as @a[scores={fake_points=0},tag=playing] run tellraw @a [{"translate":"\nVictor: ","color":"yellow"},{"selector":"@s"},{"translate":" score: ","color":"gray"},{"score":{"objective":"points","name":"@s"}}]
...
execute as @a[scores={fake_points=0},tag=playing,tag=!got_placement] run tellraw @a [{"selector":"@s"},{"translate":" score: ","color":"gray"},{"score":{"objective":"points","name":"@s"}}]
tag @a[scores={fake_points=0},tag=playing] add got_placement
scoreboard players set $check_place fake_points -1000
execute as @a[tag=playing,tag=!got_placement] at @s run scoreboard players operation @s fake_points = @s points
execute as @a[tag=playing,tag=!got_placement] at @s run scoreboard players operation $check_place fake_points > @s points
