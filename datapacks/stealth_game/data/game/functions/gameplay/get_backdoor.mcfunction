...
execute if score $check_band band_number matches 1.. run item replace entity @s hotbar.4 with carrot_on_a_stick{HideFlags:63,CustomModelData:5,display:{Name:'[{"translate":"Click to warp to the final hallway","color":"red","italic":false}]'}}
