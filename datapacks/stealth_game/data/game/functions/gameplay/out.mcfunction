...
team join dark_gray
execute if entity @s[scores={death_msg=0}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" is out.","color":"gold"}]
execute if entity @s[scores={death_msg=1}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" stopped running.","color":"gold"}]
execute if entity @s[scores={death_msg=2}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" vanished.","color":"gold"}]
execute if entity @s[scores={death_msg=3}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" didn't see the tutorial.","color":"gold"}]
execute if entity @s[scores={death_msg=4}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" wanted to play a different game.","color":"gold"}]
execute if entity @s[scores={death_msg=5}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" got doomed.","color":"gold"}]
execute if entity @s[scores={death_msg=6}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" left the Colosseum.","color":"gold"}]
execute if entity @s[scores={death_msg=7}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" just plain died.","color":"gold"}]
execute if entity @s[scores={death_msg=8}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" found a gladiator.","color":"gold"}]
execute if entity @s[scores={death_msg=9}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" would rather spectate.","color":"gold"}]
execute if entity @s[scores={death_msg=10}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" was a casualty of the trident.","color":"gold"}]
execute if entity @s[scores={death_msg=11}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" just wanted to stand on the finish line.","color":"gold"}]
execute if entity @s[scores={death_msg=12}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" hugged a gladiator.","color":"gold"}]
execute if entity @s[scores={death_msg=13}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" tried, but not hard enough.","color":"gold"}]
execute if entity @s[scores={death_msg=14}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" is waiting for a medic.","color":"gold"}]
execute if entity @s[scores={death_msg=15}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" learned you were supposed to be sneaky.","color":"gold"}]
execute if entity @s[scores={death_msg=16}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" forgot they were wearing sneakers.","color":"gold"}]
execute if entity @s[scores={death_msg=17}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" lacked stealth.","color":"gold"}]
execute if entity @s[scores={death_msg=18}] run tellraw @a[tag=playing] [{"selector":"@s"},{"translate":" just wanted to show off their death message.","color":"gold"}]
team join dead @s
effect clear @s
