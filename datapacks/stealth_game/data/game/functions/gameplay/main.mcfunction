...
execute as @a[team=gladiator] at @s unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:carrot_on_a_stick"}]}] run function game:gameplay/get_helmet
...
execute as @a[tag=playing,team=sneaker] at @s if block ~ 150 ~ polished_basalt if block ~ 125 ~ diamond_block run function game:gameplay/step_on_band
...
execute as @a[team=gladiator,tag=playing] at @s unless entity @s[nbt={Inventory:[{Slot:1b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}}]}] unless entity @s[nbt={Inventory:[{Slot:1b,id:"minecraft:trident"}]}] unless entity @s[scores={dash_cooldown=1..}] run function game:gameplay/get_dash
