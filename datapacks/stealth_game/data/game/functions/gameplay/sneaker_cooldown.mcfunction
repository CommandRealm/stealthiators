...
scoreboard players add @a[tag=playing,team=won] stat_r_win 1
scoreboard players add @a[tag=playing,team=dead] stat_r_win 1
advancement grant @a[tag=playing,scores={stat_r_win=1..}] only advancements:custom/win_as_runner
