...
execute if score $second bossbar_time matches 10.. run bossbar set minecraft:time_till_end name [{"translate":"Time remaining: ","color":"gold"},{"score":{"objective":"bossbar_time","name":"$minute"},"color":"red"},{"translate":":","color":"dark_red"},{"score":{"objective":"bossbar_time","name":"$second"},"color":"red"}]
execute if score $second bossbar_time matches ..9 run bossbar set minecraft:time_till_end name [{"translate":"Time remaining: ","color":"gold"},{"score":{"objective":"bossbar_time","name":"$minute"},"color":"red"},{"translate":":","color":"dark_red"},{"translate":"0","color":"red"},{"score":{"objective":"bossbar_time","name":"$second"},"color":"red"}]
