...
execute unless entity @s[scores={dash_cooldown=1..}] run item replace entity @s hotbar.1 with carrot_on_a_stick{CustomModelData:1,display:{Name:'{"text":"Dash","color":"#9dfff5","italic":false}'}}
