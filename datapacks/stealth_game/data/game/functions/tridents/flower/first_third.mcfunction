execute if score $rand random matches 0 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:oak_sapling",Count:1b},Age:5975,PickupDelay:1000,Tags:["die"]}
execute if score $rand random matches 1 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:spruce_sapling",Count:1b},Age:5975,PickupDelay:1000,Tags:["die"]}
execute if score $rand random matches 2 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:birch_sapling",Count:1b},Age:5975,PickupDelay:1000,Tags:["die"]}
