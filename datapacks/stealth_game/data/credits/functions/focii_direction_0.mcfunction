...
scoreboard players add @e[tag=focii,type=armor_stand] focii_leg 25
...
scoreboard players set @e[tag=focii,type=armor_stand,scores={focii_leg=85..}] focii_direction 1