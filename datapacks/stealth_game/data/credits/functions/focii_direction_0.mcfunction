...
scoreboard players add @e[type=minecraft:armor_stand,tag=focii] focii_leg 25
...
scoreboard players set @e[type=minecraft:armor_stand,tag=focii,scores={focii_leg=85..}] focii_direction 1
return 1