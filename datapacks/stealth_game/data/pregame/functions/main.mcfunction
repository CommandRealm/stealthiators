...
execute as @a[tag=!playing,gamemode=adventure,scores={ready=0}] unless entity @s[x=0,y=66,z=0,distance=..300,nbt={SelectedItem:{id:"minecraft:written_book"}}] run title @s[x=57,y=73,z=7,distance=17..] actionbar [{"translate":"You will spectate. ","color":"gray"},{"translate":"(","color":"dark_gray","bold":true},{"score":{"objective":"players_ready","name":"$number"},"color":"gray","bold":false},{"translate":"/","color":"gray"},{"score":{"objective":"players_on","name":"$number"},"color":"gray"},{"translate":")","color":"dark_gray","bold":true}]
execute as @a[tag=!playing,gamemode=adventure,scores={ready=1}] unless entity @s[x=0,y=66,z=0,distance=..300,nbt={SelectedItem:{id:"minecraft:written_book"}}] run title @s[x=57,y=73,z=7,distance=17..] actionbar [{"translate":"You will play. ","color":"dark_gray"},{"translate":"(","color":"dark_gray","bold":true},{"score":{"objective":"players_ready","name":"$number"},"color":"gray","bold":false},{"translate":"/","color":"gray"},{"score":{"objective":"players_on","name":"$number"},"color":"gray"},{"translate":")","color":"dark_gray","bold":true}]
...
# press button
execute if block 35 70 -40 stone_button[powered=true] run function pregame:press_button