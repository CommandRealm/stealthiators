...
execute if score $number players_ready matches 2.. run title @a title [{"score":{"objective":"display_timer","name":"$time"},"color":"dark_gray"},{"text":" seconds","color":"#777777"}]
execute if score $number players_ready matches 2.. if score $time display_timer matches 1 run title @a title [{"score":{"objective":"display_timer","name":"$time"},"color":"dark_gray"},{"text":" second","color":"#777777"}]
execute if score $number players_ready matches 2.. run title @a[scores={ready=0}] subtitle [{"text":"to join the game","color":"#3e0003"}]
