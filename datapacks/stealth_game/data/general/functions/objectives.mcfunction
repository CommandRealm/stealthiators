...
setblock 0 0 0 minecraft:shulker_box{Lock:" please leave locked, ty"}
...
kill @e[type=minecraft:area_effect_cloud,tag=spin]
summon minecraft:area_effect_cloud 0 0 0 {Duration:10000000,Tags:["spin"]}
...
execute at @a[x=0,y=66,z=0,distance=..300] if entity @e[type=minecraft:villager,distance=..6,tag=market_villager] run function lobby:villagers/main
...
kill @e[type=minecraft:area_effect_cloud,tag=tutorial_text]
summon minecraft:area_effect_cloud 157 81 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"Every "},{"text":"runner\'s","color":"gray"},{"text":" goal is to reach the","color":"white"}]'}
summon minecraft:area_effect_cloud 157 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"end of the map without getting caught."}]'}

summon minecraft:area_effect_cloud 157 80.25 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"Only the "},{"text":"runner\'s","color":"gray"},{"text":" feet are visible,","color":"white"}]'}
summon minecraft:area_effect_cloud 157 80.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"meaning you can hide behind single blocks."}]'}

summon minecraft:area_effect_cloud 163.75 81 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"The map randomly generates at the start of each game."}]'}
summon minecraft:area_effect_cloud 163.75 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"The width of each area becomes"}]'}
summon minecraft:area_effect_cloud 163.75 80.5 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"progressively smaller near the finish line."}]'}

summon minecraft:area_effect_cloud 171.0 81.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"There are basalt bands between each segment."}]'}
summon minecraft:area_effect_cloud 171.0 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"Crossing a new band will notify the "},{"text":"gladiators.","color":"red"}]'}

summon minecraft:area_effect_cloud 178.0 81.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"The "},{"text":"gladiator\'s","color":"red"},{"text":" goal is to stop the runners","color":"white"}]'}
summon minecraft:area_effect_cloud 178.0 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"from reaching the finish line."}]'}
summon minecraft:area_effect_cloud 183.5 81.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"Gladiators","color":"red"},{"text":" can eliminate ","color":"white"},{"text":"runners","color":"gray"}]'}
summon minecraft:area_effect_cloud 183.5 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"in a single hit by throwing their trident","color":"white"}]'}
summon minecraft:area_effect_cloud 183.5 80.5 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"or punching them.","color":"white"}]'}

summon minecraft:area_effect_cloud 188.75 81.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"Gladiators","color":"red"},{"text":" have a dash item","color":"white"}]'}
summon minecraft:area_effect_cloud 188.75 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"as well as a \\"backdoor\\" item","color":"white"}]'}
summon minecraft:area_effect_cloud 188.75 80.5 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"that will warp them","color":"white"}]'}
summon minecraft:area_effect_cloud 188.75 80.25 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"two bands back from"}]'}
summon minecraft:area_effect_cloud 188.75 80.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"the farthest ahead ","color":"white"},{"text":"runner.","color":"gray"}]'}
summon minecraft:area_effect_cloud 188.75 79.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"You want to use this if a"}]'}
summon minecraft:area_effect_cloud 188.75 79.5 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"runner","color":"gray"},{"text":" gets beyond you.","color":"white"}]'}

summon minecraft:area_effect_cloud 192.65 81.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"The "},{"text":"gladiators","color":"red"},{"text":" win the match","color":"white"}]'}
summon minecraft:area_effect_cloud 192.65 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"as long as they stop at least"}]'}
summon minecraft:area_effect_cloud 192.65 80.5 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"half of the "},{"text":"runners","color":"gray"}]'}
summon minecraft:area_effect_cloud 192.65 80.25 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"from reaching the end.","color":"white"}]'}

summon minecraft:area_effect_cloud 196.65 81.0 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"Eliminated "},{"text":"runners","color":"gray"},{"text":" can still win ","color":"white"}]'}
summon minecraft:area_effect_cloud 196.65 80.75 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"the match as long as half of"}]'}
summon minecraft:area_effect_cloud 196.65 80.5 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"the original "},{"text":"runners","color":"gray"}]'}
summon minecraft:area_effect_cloud 196.65 80.25 -108 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"touch the finish line.","color":"white"}]'}

summon minecraft:area_effect_cloud 200 81.25 -106.25 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"Each team has four","color":"white"}]'}
summon minecraft:area_effect_cloud 200 81.0 -106.25 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"custom classes.","color":"white"}]'}
summon minecraft:area_effect_cloud 200 80.75 -106.25 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"You can select them in","color":"white"}]'}
summon minecraft:area_effect_cloud 200 80.5 -106.25 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"your book or during the","color":"white"}]'}
summon minecraft:area_effect_cloud 200 80.25 -106.25 {Duration:100000000,Tags:["tutorial_text"],CustomNameVisible:1b,CustomName:'[{"text":"warmup phase of the game.","color":"white"}]'}
...
kill @e[type=minecraft:armor_stand,tag=tutorial_3_1]
kill @e[type=minecraft:armor_stand,tag=tutorial_3_2]
summon minecraft:armor_stand 178 82.05 -109 {NoGravity:1b,Tags:["tutorial_3_1"],Invisible:1b,DisabledSlots:2039583,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:16},Count:1b}],Pose:{RightArm:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],RightLeg:[0.0f,0.0f,0.0f],LeftLeg:[0.0f,0.0f,0.0f],Body:[0.0f,0.0f,0.0f],Head:[1.0f,0.0f,0.0f]},ShowArms:1b,Rotation:[90.0f,0.0f]}
summon minecraft:armor_stand 178 82 -109 {NoBasePlate:1b,Tags:["tutorial_3_2"],Invisible:0b,DisabledSlots:2039583,Invulnerable:1b,ArmorItems:[{id:"minecraft:netherite_boots",Count:1b},{id:"minecraft:iron_leggings",Count:1b},{id:"minecraft:leather_chestplate",tag:{display:{color:9209957}},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:[I;1557211511,1441743481,-1420206844,721358116],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZDk0N2RjOTgyM2I1Nzk2NjJlMzZhMTZkZmNlOTUxYzRlNDFkMmUwYWJhM2Q2NWI3YWU3ZmRlNTkxZDg3OWVkIn19fQ=="}]}}},Count:1b}],HandItems:[{id:"minecraft:trident",tag:{Enchantments:[{id:"minecraft:x",lvl:1s}]},Count:1b},{}],Pose:{RightArm:[-30.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],RightLeg:[0.0f,0.0f,0.0f],LeftLeg:[0.0f,0.0f,0.0f],Body:[0.0f,0.0f,0.0f],Head:[2.0f,0.0f,0.0f]},ShowArms:1b,Rotation:[90.0f,0.0f]}
scoreboard players set @e[tag=tutorial_3_2] tutorial 0

kill @e[type=minecraft:armor_stand,tag=tutorial_4_1]
kill @e[type=minecraft:armor_stand,tag=tutorial_4_2]
summon minecraft:armor_stand 184 80.05 -109 {NoGravity:1b,Tags:["tutorial_4_1"],Invisible:1b,DisabledSlots:2039583,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:16},Count:1b}],Pose:{RightArm:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],RightLeg:[0.0f,0.0f,0.0f],LeftLeg:[0.0f,0.0f,0.0f],Body:[0.0f,0.0f,0.0f],Head:[1.0f,0.0f,0.0f]},ShowArms:1b,Rotation:[115.0f,0.0f]}
summon minecraft:armor_stand 184 80 -109 {NoBasePlate:1b,Tags:["tutorial_4_2"],Invisible:0b,DisabledSlots:2039583,Invulnerable:1b,ArmorItems:[{id:"minecraft:netherite_boots",Count:1b},{id:"minecraft:iron_leggings",Count:1b},{id:"minecraft:leather_chestplate",tag:{display:{color:9209957}},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:[I;1557211511,1441743481,-1420206844,721358116],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZDk0N2RjOTgyM2I1Nzk2NjJlMzZhMTZkZmNlOTUxYzRlNDFkMmUwYWJhM2Q2NWI3YWU3ZmRlNTkxZDg3OWVkIn19fQ=="}]}}},Count:1b}],HandItems:[{id:"minecraft:trident",tag:{Enchantments:[{id:"minecraft:x",lvl:1s}]},Count:1b},{}],Pose:{RightArm:[200.0f,180.0f,340.0f],LeftArm:[0.0f,0.0f,0.0f],RightLeg:[0.0f,0.0f,0.0f],LeftLeg:[0.0f,0.0f,0.0f],Body:[0.0f,0.0f,0.0f],Head:[2.0f,0.0f,0.0f]},ShowArms:1b,Rotation:[115.0f,0.0f]}
scoreboard players set @e[type=minecraft:armor_stand,tag=tutorial_4_2] tutorial 0
scoreboard objectives add tutorial_tp dummy
kill @e[type=minecraft:area_effect_cloud,tag=tutorial_tp]
kill @e[type=minecraft:area_effect_cloud,tag=tutorial_tp_2]
summon minecraft:area_effect_cloud 32 69 -31 {Tags:["tutorial_tp","tutorial_tp_particles"],Duration:100000000}
summon minecraft:area_effect_cloud 203 82 -105 {Tags:["tutorial_tp_2","tutorial_tp_particles"],Duration:100000000}
scoreboard players add @e[type=minecraft:area_effect_cloud,tag=tutorial_tp] tutorial_tp 0
scoreboard players add @e[type=minecraft:area_effect_cloud,tag=tutorial_tp_2] tutorial_tp 0

kill @e[type=minecraft:area_effect_cloud,tag=teleport_nameplate]
summon minecraft:area_effect_cloud 32 71 -31 {Duration:10000000,Tags:["teleport_nameplate"],CustomNameVisible:1b}
kill @e[type=minecraft:area_effect_cloud,tag=teleport_nameplate_2]
summon minecraft:area_effect_cloud 203 84 -105 {Duration:10000000,Tags:["teleport_nameplate_2"],CustomNameVisible:1b}
...
kill @e[type=minecraft:area_effect_cloud,tag=minigame_target]
summon minecraft:area_effect_cloud 77 77 6 {Duration:10000000,Tags:["minigame_target"]}
summon minecraft:area_effect_cloud 70 82 9 {Duration:10000000,Tags:["minigame_target"]}
summon minecraft:area_effect_cloud 71 82 22 {Duration:10000000,Tags:["minigame_target"]}
summon minecraft:area_effect_cloud 57 76 18 {Duration:10000000,Tags:["minigame_target"]}
summon minecraft:area_effect_cloud 57 85 29 {Duration:10000000,Tags:["minigame_target"]}
summon minecraft:area_effect_cloud 50 89 30 {Duration:10000000,Tags:["minigame_target"]}
...
kill @e[type=minecraft:area_effect_cloud,tag=target_text]
scoreboard players set $highscore lobby_minigame 0
summon minecraft:area_effect_cloud 45 74.0 3 {Duration:1000000,Tags:["target_text"],CustomNameVisible:1b,CustomName:'[{"text":"Gladiator Practice","color":"#9c9558","bold":true}]'}
summon minecraft:area_effect_cloud 45 73.75 3 {Duration:1000000,Tags:["target_text","highscore_nameplate"],CustomNameVisible:1b,CustomName:'[{"text":"Highscore: ","color":"gold"},{"text":"None","color":"yellow"}]'}
summon minecraft:area_effect_cloud 45 73.5 3 {Duration:1000000,Tags:["target_text","highscore_nameplate","get_highscore_name"],CustomNameVisible:1b,CustomName:'[{"text":"Held by: ","color":"dark_green"},{"text":"No one","color":"green"}]'}
...
kill @e[type=minecraft:area_effect_cloud,tag=start_button_text]
summon minecraft:area_effect_cloud 34 71 -40 {Duration:1000000,Tags:["start_button_text"],CustomNameVisible:1b,CustomName:'[{"text":"- ","color":"gray"},{"text":"🗡","color":"#9c9558","bold":true},{"text":" Start ","color":"gold"},{"text":"🗡","color":"#9c9558","bold":true},{"text":" -","color":"gray"}]'}
